...
SECRET_KEY = 'django-insecure-0s_%^r4pwp1j87qci6kxn)fy@a)0qj2cxizyrqxg%xz@o!*g^8'
...
CSRF_TRUSTED_ORIGINS = ['https://witdevel.ru', 'https://*.witdevel.ru']
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': '/app_testing/db_folder/db.sqlite3',
    }
}
